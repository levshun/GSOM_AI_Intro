...
- Recognize advanced capabilities (tools, retrieval/RAG, agents) and the main limitations and ethical risks of AI assistants.
...
| 4 | 4 | Advanced capabilities, using AI for academic sources, limits and ethics |
